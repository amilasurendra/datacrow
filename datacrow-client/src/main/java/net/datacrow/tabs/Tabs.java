...
public class Tabs {
	...
	private static final Map<Integer, List<Tab>> moduleTabs = new HashMap<Integer, List<Tab>>();
	...
	public void addTab(Tab tab) {
		List<Tab> tabs = moduleTabs.get(Integer.valueOf(tab.getModule()));
		tabs = tabs == null ? new ArrayList<Tab>() : tabs;
	...
	public List<Tab> getTabs(int module) {
		...
		List<Tab> tabs = moduleTabs.get(idx);
